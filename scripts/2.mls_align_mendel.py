...
def save_point_cloud(cloud, output_path):    #the save point cloud function lacks all metadata fields originally in the laz cloud
...
for plot in plots:
    ...
    reference_path = os.path.join(path, "plot1", f"{plot}_cloud.ply")
    ...
    for adj_plot in adjacent_plots:
        target_path = os.path.join(path, "plot1", f"{adj_plot}_cloud.ply")
        ...
        if fitness < score_threshold:
            ...
            if result_matrix is not None:
                ...
                o3d.io.write_point_cloud(target_path, target_transformed)
